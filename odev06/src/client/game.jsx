...
export class Game extends Component {
    ...
    render() {
        ...
        // oyun bitiş kontrolü yapılıyor
        if (isFinish) {
            //bitmiş ise kazanılmasına veya kaybetmesine göre render ediliyor
            if (win) {
                return (<div>
                    <h2>Kazandın!</h2>
                    <h3>Skor:{this.state.score}</h3>
                    <img  className="kart" src="img/kedi.png" />
    ...
    gameFinish = (answer) => {
        ...
        this.setState({ isFinish: true, win: answer }, function () {
